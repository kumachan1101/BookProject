...
static void name##_destroy(void* context) { free(context); } \
...
#### 全体構造図（ファイル構成と依存関係） (原則適用後の構造（DIP準拠）)
...
しかし、知識として知っていることと、現場で息をするように使いこなせることの間には、まだ少しの壁があります。次の[[19_第2部 第15章：SOLID原則を「使える思考」にする]]では、これまで学んだすべての知識を統合し、設計の現場で判断を下す際の「思考プロセス」そのものを言語化します。
